...
El robot Scorbot incorpora encoders incrementales en cada una de las articulaciones, este sensor entrega información posición de forma cuantizada. Durante pruebas realizadas al robot se determinó que la velocidad máxima de los motores es cercana a las 100 RPM.

Grafico de velocidad

En el controlador de velocidad se considero un modelo de identificación en medición de periodo, el cual entrega buenos resultado a bajas velocidades.
