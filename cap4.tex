...
De esta forma se configuró un montaje para disponer de todos los controladores de forma alineada, esta configuración se muestra en la Figura \ref{cap4_montaje}. Todos los controladores estan conectados siguiendo la mismo orden fisíco de la cadena cinemática del robot.
