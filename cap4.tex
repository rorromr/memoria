...
El microcontrolador corresponde al Infineon XMC4700, pues posee un conjunto de periféricos ideal para el tipo de aplicación requerida. Básicamente se utilizó
