...
El microcontrolador corresponde al Infineon XMC4800, pues posee un conjunto de periféricos ideal para el tipo de aplicación requerida. Para reducir el tiempo de desarrollo y simplificar la implmentación se usó como elemento base la placa de desarrollo del microcontrolador y puente H, de esta forma se diseñó una placa para el montaje de las placas de desarrollo usando una estructura por pisos (\textit{stackable}).
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.45\textwidth]{img/cap4/top_pcb}
  \caption{PCB cara superior (\textit{top}).}
  \label{cap4_top_pcb}
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.45\textwidth]{img/cap4/bottom_pcb}
  \caption{PCB cara inferior (\textit{bottom}).}
