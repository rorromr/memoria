...
Para la etapa de control del motor del motor de corriente continua es necesario contar con un sensor de corriente. Existen deversas tecnologías y tecnicas de medición de corrientes disponibles.

HABLAR SOBRE: SHUNT, HALL
Problemas de amplificacion, trnasmision sin ruido y aislación

En el desarrollo de este trabajo se consideró el uso de un senso de efecto hall Infineon TLI4970, su principal caracteristica corresponde a la integración del ADC dentro del mismo package, por lo que la salida del sensor es digital usando el protocolo SPI. Esto reduce la cantidad de elementos externos necesarios, pues el sensor se conecta de forma directa al un puerto SPI del microcontrolador.

FOTO TLI

DEsventajas: precio, package, rango y ancho de banda
